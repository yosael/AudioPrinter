...
public class CreditoFiscalSvTrade {
	...
	private String giro;
	private String notaNumRemisionAnterior;
	private String vtaActaDe;
	private Date fechaNotaRemisionAnterior;
	...
	public String getNotaNumRemisionAnterior() {
		return notaNumRemisionAnterior;
	}
	public void setNotaNumRemisionAnterior(String notaNumRemisionAnterior) {
		this.notaNumRemisionAnterior = notaNumRemisionAnterior;
	}
	public String getVtaActaDe() {
		return vtaActaDe;
	}
	public void setVtaActaDe(String vtaActaDe) {
		this.vtaActaDe = vtaActaDe;
	}
	public Date getFechaNotaRemisionAnterior() {
		return fechaNotaRemisionAnterior;
	}
	public void setFechaNotaRemisionAnterior(Date fechaNotaRemisionAnterior) {
		this.fechaNotaRemisionAnterior = fechaNotaRemisionAnterior;
	}
