...
@ManagedBean(name = "generarFacturaSvTradeBean")
@ViewScoped
public class GenerarFacturaSvTradeBean {
	...
	public GenerarFacturaSvTradeBean() {
	...
	public void cargarFactura()
	{
		...
		try {
			...
			System.out.println("Entro a cargar factura id "+idFactura);
			if(idFactura>0)
			{
