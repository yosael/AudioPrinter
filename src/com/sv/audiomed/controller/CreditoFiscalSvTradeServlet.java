...
@WebServlet("/creditoFiscalSvTradeServlet")
public class CreditoFiscalSvTradeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			resp.setHeader("Content-Disposition", "inline;filename=" + "CreditoFiscalSvTrade" + ".pdf");
