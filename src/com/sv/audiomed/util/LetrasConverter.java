...
public class LetrasConverter {
	...
	public LetrasConverter(){
		numero = 0;
		flag=0;
	}
	public LetrasConverter(int n){
		numero = n;
		flag=0;
	}
	...
	public String obtenerDecimal(Double numero)
	{
		
		int parteEntera=numero.intValue();
		double parteDecimal=numero-parteEntera;
		double finalDecimal=parteDecimal*100;
		String decimalLetras=finalDecimal+"/100";
		return decimalLetras;
	}
	
	/*public String convertir(int numero1,Double numero2)
	{
		String letras1=convertirLetras(numero1);
		String letras2
	}*/
	...
	public String convertir(Double numero)
	{
		...
		letras=convertirLetras(parteEntera);
		
		if(parteDecimal>0)
		{
			
			int finalDecimal=moneyDecimal(parteDecimal*100).intValue();
			String decimalLetras=finalDecimal+"/100";
			
			letras+=" con "+decimalLetras;
